...
<template>
  <nav class="p-400 mx-auto lg:max-w-7xl flex items-start md:items-center justify-between">
    ...
    <div class="md:hidden pt-100" >
      <button @click="openMenu" class="text-neutrals-900 hover:bg-white/5 focus:outline-2 focus:-outline-offset-1 focus:outline-laranja-600">
    ...
    <div class="hidden md:flex items-center gap-1200">
      <img src="../../assets/search-icon.svg" alt="Lupa" />
  ...
  <transition name="slide">
    <div v-if="isMobileMenuOpen"
      ...
      <nav class="flex-1 px-400 py-600 space-y-800">
        <details open>
          <summary class="font-body font-semibold text-neutrals-900 uppercase flex justify-between pb-300 border-b hover:cursor-pointer">
            PROGRAMAÇÃO
            <svg class="accordion-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M7.64663 4.64621C7.69308 4.59964 7.74825 4.5627 7.809 4.53749C7.86974 4.51229 7.93486 4.49931 8.00063 4.49931C8.0664 4.49931 8.13152 4.51229 8.19226 4.53749C8.25301 4.5627 8.30819 4.59964 8.35463 4.64621L14.3546 10.6462C14.4485 10.7401 14.5013 10.8674 14.5013 11.0002C14.5013 11.133 14.4485 11.2603 14.3546 11.3542C14.2607 11.4481 14.1334 11.5008 14.0006 11.5008C13.8679 11.5008 13.7405 11.4481 13.6466 11.3542L8.00063 5.70721L2.35463 11.3542C2.26075 11.4481 2.13341 11.5008 2.00063 11.5008C1.86786 11.5008 1.74052 11.4481 1.64663 11.3542C1.55274 11.2603 1.5 11.133 1.5 11.0002C1.5 10.8674 1.55274 10.7401 1.64663 10.6462L7.64663 4.64621Z" fill="#3B3935"/>
            </svg>
          </summary>
        ...
        <details>
          <summary class="font-body font-semibold text-neutrals-900 uppercase flex justify-between">
            edição 2024
            <svg class="accordion-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M7.64663 4.64621C7.69308 4.59964 7.74825 4.5627 7.809 4.53749C7.86974 4.51229 7.93486 4.49931 8.00063 4.49931C8.0664 4.49931 8.13152 4.51229 8.19226 4.53749C8.25301 4.5627 8.30819 4.59964 8.35463 4.64621L14.3546 10.6462C14.4485 10.7401 14.5013 10.8674 14.5013 11.0002C14.5013 11.133 14.4485 11.2603 14.3546 11.3542C14.2607 11.4481 14.1334 11.5008 14.0006 11.5008C13.8679 11.5008 13.7405 11.4481 13.6466 11.3542L8.00063 5.70721L2.35463 11.3542C2.26075 11.4481 2.13341 11.5008 2.00063 11.5008C1.86786 11.5008 1.74052 11.4481 1.64663 11.3542C1.55274 11.2603 1.5 11.133 1.5 11.0002C1.5 10.8674 1.55274 10.7401 1.64663 10.6462L7.64663 4.64621Z" fill="#3B3935"/>
            </svg>
        ...
        <details>
          <summary class="font-bold">SOBRE NÓS</summary>
        </details>
        <details>
          <summary class="font-bold">NOTÍCIAS</summary>
        </details>
        <details>
          <summary class="font-bold">MÍDIAS</summary>
        </details>
        <details>
          <summary class="font-bold">INFORMAÇÕES</summary>
        </details>
...
details svg.accordion-icon {
  transition: transform .2s ease;
  transform: rotate(180deg);
}
details[open] svg.accordion-icon {
